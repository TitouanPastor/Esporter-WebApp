...
class TournoiDAO
{
    ...
    public function insertEtreInscrit($idTournoi, $idEquipe, $idJeu, $idPoule)
    {
        $req = $this->linkpdo->prepare('INSERT INTO etre_inscrit VALUES (:idEquipe, :idTournoi, :idJeu, :idPoule,0)');
        $req->execute(
            array(
                'idTournoi' => $idTournoi,
                'idEquipe' => $idEquipe,
